...
export default function ItemDetail(props) {
  const { buttonLabel, buttonLove, product } = props;
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-3">
              ...
              <p className="text-3xl text-gray-900">Nilai Limit: {product.price}</p>
              <p className="text-3xl text-gray-900">Jaminan: {product.price}</p>
            </div>
    ...
    images: [
      {
        _id: 1,
        name: 'Angled view',
        src: '/lelang/vespa1.jpg',
        alt: 'Angled front view with bag zipped and handles upright.',
      },
      {
        _id: 2,
        name: 'Angled view',
        src: '/lelang/vespa2.jpg',
        alt: 'Angled front view with bag zipped and handles upright.',
      },
      {
        _id: 3,
        name: 'Angled view',
        src: '/lelang/vespa3.jpg',
        alt: 'Angled front view with bag zipped and handles upright.',
      },
      {
        _id: 4,
        name: 'Angled view',
        src: '/lelang/vespa4.jpg',
        alt: 'Angled front view with bag zipped and handles upright.',
      },
    ],
    // images: [
