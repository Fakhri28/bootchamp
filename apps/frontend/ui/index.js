    ...
    return (
      <Switch>
        ...
        <Route
          exact
          path="/announcement"
          render={(routeProps) => <AnnouncementPage {...routeProps} {...props} {...state} />}
        />
        <Route
          exact
          path="/Item"
          render={(routeProps) => <ItemPage {...routeProps} {...props} {...state} />}
        />
...
export default withTrackerSsr(() => initApp())(FrontendApp);
