...
const UserSettingListDraftPage = (props) => {
  ...
  return (
    <WrapperList
      ...
      publishName="listUserSettingDraft"
...
UserSettingListDraftPage.defaultProps = {
...
UserSettingListDraftPage.propTypes = {
