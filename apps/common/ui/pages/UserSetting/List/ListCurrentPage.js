...
const UserSettingListCurrentPage = (props) => {
  ...
  return (
    <WrapperList
      ...
      publishName="listUserSettingCurrent"
...
UserSettingListCurrentPage.defaultProps = {
...
UserSettingListCurrentPage.propTypes = {
