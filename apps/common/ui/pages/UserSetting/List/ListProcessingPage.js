...
const UserSettingListProcessingPage = (props) => {
  ...
  return (
    <WrapperList
      ...
      publishName="listUserSettingProcessing"
...
UserSettingListProcessingPage.defaultProps = {
...
UserSettingListProcessingPage.propTypes = {
