...
const UserLogListProcessingPage = (props) => {
  ...
  return (
    <WrapperList
      ...
      publishName="listUserLogProcessing"
...
UserLogListProcessingPage.defaultProps = {
...
UserLogListProcessingPage.propTypes = {
