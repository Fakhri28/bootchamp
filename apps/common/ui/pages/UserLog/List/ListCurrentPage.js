...
const UserLogListCurrentPage = (props) => {
  ...
  return (
    <WrapperList
      ...
      publishName="listUserLogCurrent"
...
UserLogListCurrentPage.defaultProps = {
...
UserLogListCurrentPage.propTypes = {
